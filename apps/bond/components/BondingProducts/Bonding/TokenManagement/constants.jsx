...
export const WHIRLPOOL = new web3.PublicKey(ADDRESSES[VM_TYPE.SVM].balancerVault);
export const SOL = new web3.PublicKey('So11111111111111111111111111111111111111112');
...
export const TICK_ARRAY_LOWER = new web3.PublicKey('3oJAqTKTCdGvLS9zpoBquWvMjwthu9Np67Qp4W8AT843');
export const TICK_ARRAY_UPPER = new web3.PublicKey('J3eMJUQWLmSsG5VnXVFHCGwakpKmzi4jkNvi3vbCZQ3o');
