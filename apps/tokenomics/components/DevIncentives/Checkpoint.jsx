  ...
  return (
    <CheckpointContainer>
      ...
      <div className="btn-container">
        <Button size="large" type="primary" onClick={onCheckpointCall} loading={isLoading}>
          Checkpoint
        </Button>
      </div>

      <Alert message="Note that this will trigger a transaction" type="info" className="mt-16" />
