...
const getShimmerStringSVGMarkup = (w = DEFAULT_SIZE.width, h = DEFAULT_SIZE.height) => `
...
export const NftImage = ({ imageUrl, isSmallSize }) => {
  ...
  const blurDataURL = `data:image/svg+xml;base64,${window.btoa(
    getShimmerStringSVGMarkup(imageSize.width, imageSize.height),
  )}`;
  ...
  return (
    <Image
      ...
      style={{ border: `1px solid ${COLOR.BORDER_GREY}` }}
    />
  );
};
