...
export const MARKETPLACE_SUBGRAPH_CLIENTS = {
  ...
  // Robinhood is an SQD squid, not a subgraph — OpenReader dialect, see ./dialect.ts.
  4663: new GraphQLClient(
    process.env.NEXT_PUBLIC_ROBINHOOD_MARKETPLACE_SUBGRAPH_URL!,
    requestConfig,
  ),
} as const;
