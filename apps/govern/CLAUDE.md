...
- **Wallet**: Reown AppKit (Wagmi adapter). See `context/AppKitProvider.tsx`, `components/Login/`, `components/Contracts/`, `components/Donate/`, `components/Proposals/`, `components/VeOlas/`.
- **State**: Redux (`store/`).
