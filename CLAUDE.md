...
- RainbowKit for wallet connections (over Wagmi). Requires a WalletConnect Cloud projectId set via `NEXT_PUBLIC_WALLET_PROJECT_ID` for `getDefaultConfig` / `connectorsForWallets`.
